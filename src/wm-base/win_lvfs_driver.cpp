...
#define CheckFlag(val, flag) if (val&flag) { DbgPrint(L"\t" L#flag L"\n"); }
    ...
    PDOKAN_FILE_INFO		DokanFileInfo)
  {
    ...
    */
    ...
    if (CreationDisposition == CREATE_NEW)
    {
	  ...
	  int res = _pFileProxy->CreateFileW(QString::fromWCharArray(filePath));
	  if(res != eNO_ERROR)
      {
    ...
    PDOKAN_FILE_INFO		/*DokanFileInfo*/)
  {
	...
	int res = _pFileProxy->CreateDirectoryW(QString::fromWCharArray(filePath));
    ...
    PDOKAN_FILE_INFO	/*DokanFileInfo*/)
  {
	...
	int res = _pFileProxy->RemoveFile(QString::fromWCharArray(filePath));
	if(res == eERROR_WRONG_STATE)
	{
		return ERROR_NOT_SUPPORTED;
	}
    ...
    PDOKAN_FILE_INFO	/*DokanFileInfo*/)
  {
	...
	*/
    ...
    //{
	  ...
	  int res = _pFileProxy->RemoveDir(QString::fromWCharArray(filePath));
      if(res == eERROR_WRONG_STATE)
	  {
		return ERROR_NOT_SUPPORTED;
	  }
    ...
    PDOKAN_FILE_INFO	DokanFileInfo)
  {
	...
	int res = _pFileProxy->MoveElement(QString::fromWCharArray(filePath)
    ...
    {
        res =_pFileProxy->MoveElement(QString::fromWCharArray(filePath)
