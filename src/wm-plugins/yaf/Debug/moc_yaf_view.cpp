...
**
** Created: Sat 3. Nov 19:34:17 2012
...
void Ui::YafView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        YafView *_t = static_cast<YafView *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Ui::YafView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Ui::YafView::staticMetaObject = {
    { &PluginView::staticMetaObject, qt_meta_stringdata_Ui__YafView,
      qt_meta_data_Ui__YafView, &staticMetaObjectExtraData }
};
