...
void RemoteDriver::YafRVFSDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData RemoteDriver::YafRVFSDriver::staticMetaObjectExtraData = {
...
const QMetaObject RemoteDriver::YafRVFSDriver::staticMetaObject = {
    { &RVFSDriver::staticMetaObject, qt_meta_stringdata_RemoteDriver__YafRVFSDriver,
      qt_meta_data_RemoteDriver__YafRVFSDriver, &staticMetaObjectExtraData }
};
