...
static const char qt_meta_stringdata_FvPlatform[] = {
    "FvPlatform\0"
};
...
const QMetaObjectExtraData FvPlatform::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FvPlatform::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_FvPlatform,
      qt_meta_data_FvPlatform, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FvPlatform::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FvPlatform))
