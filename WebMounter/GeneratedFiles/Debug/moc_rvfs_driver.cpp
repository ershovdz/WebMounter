...
const QMetaObject RemoteDriver::RVFSDriver::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_RemoteDriver__RVFSDriver,
      qt_meta_data_RemoteDriver__RVFSDriver, 0 }
};
...
int RemoteDriver::RVFSDriver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: fileUploaded(); break;
        case 2: startPlugin((*reinterpret_cast< Data::PluginSettings(*)>(_a[1]))); break;
        case 3: stopPlugin(); break;
        case 4: startSync(); break;
        case 5: stopSync(); break;
        default: ;
        }
        _id -= 6;
    }
